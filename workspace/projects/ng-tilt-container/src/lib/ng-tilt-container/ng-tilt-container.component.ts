...
@Component({
  selector: 'ng-tilt-container',
  templateUrl: './ng-tilt-container.component.html',
  styleUrls: ['./ng-tilt-container.component.css']
})
export class NgTiltContainerComponent implements OnInit, OnDestroy {
